...
$(function(){
		...
		$("#submit").on("click",function(){
			...
			var submitData ="<?php echo $arr?>mobile="+mobile+"&name="+name+"&wecha_id="+wecha_id+"&md5="+md5
			$.ajax({
				type : "POST",
				url : 'http://weixin.cheaa.com/wxcms/index.php?g=Wap&m=Diaoyan&a=setwx&id=4',
				data : submitData,
		        dataType : 'jsonp',  
		        jsonp:"jsoncallback",  
				...
				success : function(data){
					...
					if(data.success =='true'){
					   $("#success").show()
						...
						/* if(data.message =='您的微信号在24小时内已经投过票，请稍后再试'){
						   $("#chongfu").show()
						}else{ */
							$("#fail").show()
						//}
